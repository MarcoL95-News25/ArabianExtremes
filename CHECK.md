...
1. Assign the language code (i.e. 'en', 'de') as new repository secret at https://github.com/MarcoL95-News25/ArabianExtremes/settings/secrets/actions  
   * Name:  **EXTREME_LANGUAGE**   
   * Value: **Your language code here**   
### EXTREME_GH_TOKEN  
:no_entry: EXTREME_GH_TOKEN **missing**:  
1. Assign the API key as new organization secret at https://github.com/organizations/MarcoL95-News25/settings/secrets/actions/new  
